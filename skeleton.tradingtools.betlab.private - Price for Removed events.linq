...
void Main()
{
	...
	var response = http.GetStringAsync("http://192.168.49.197:8009/api/LineItem/current?excludeStatus=Suspended&excludeStatus=Opened").Result;
    ...
    var join = (from list in Lineitem
                ...
                select new 
                {
					...
					price = outcome.price,
					priceStatus = outcome.status,
					selectionKey = outcome.selectionKey
					//outcomeStatus = outcome.status
                })

                //.Where(i=> i.id == "BM_Prematch_15565540")
