...
void Main()
{
	...
	//var response = http.GetStringAsync("http://mirror.tradingfeed.tradingtools.betlab.private:8009/api/LineItem/current").Result;
    ...
    var join = (from list in Lineitem
				...
				.Where(i=> i.eventId == "BM_15170734")
                //.Where(i=> i.status == "Opened")
                //.Where(e => e.eventId == "BM_Tournament_3df86d42c2ac4791a6bdd8432a84e88b")
